...
def create_search_space(iterations=50, random_state=42) -> list:
    return [
        (
            {
                'model': Categorical(categories=[ElasticNet(random_state=random_state)], prior=None),
                ...
                'prep__numeric__imputer__transformer': Categorical(
                    categories=(
                        SimpleImputer(),
        ...
        (
            {
                'model': Categorical(
                    categories=(
                        ExtraTreesRegressor(bootstrap=True, n_estimators=500, random_state=random_state)
                    ),
                    prior=None
                ),
                ...
                'model__criterion': Categorical(categories=('squared_error',), prior=None),
                'prep__numeric__imputer__transformer': Categorical(
                    categories=(
                        SimpleImputer(),
                        SimpleImputer(strategy='median'),
        ...
        (
            {
                ...
                'prep__numeric__scaler__transformer': Categorical(categories=(None,), prior=None),
                'prep__numeric__pca__transformer': Categorical(categories=(None, PCA(n_components='mle')),
                                                               prior=None),
                'prep__non_numeric__encoder__transformer': Categorical(
                    categories=(
                        OneHotEncoder(handle_unknown='ignore'),
